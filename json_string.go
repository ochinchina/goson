...
func (jb *JsonString) Put(name string, value interface{}) error {
	return errors.New("JsonString does not support Put() operation")
}

func (jb *JsonString) Add(value interface{}) error {
	return errors.New("JsonString does not support Add() operation")
}

func (jb *JsonString) Size() int {
	return -1
}

func (jb *JsonString) GetAllPropName() ([]string, error) {
	return nil, errors.New("JsonString does not support GetAllPropName() operation")
}

func (jb *JsonString) Get(index int) (JsonElement, error) {
	return nil, errors.New("JsonString does not support Get() operation")
}

func (jb *JsonString) GetByName(name string) (JsonElement, error) {
	return nil, errors.New("JsonString does not support GetByName() operation")
}
