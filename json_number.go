...
func (jn *JsonNumber) Put(name string, value interface{}) error {
	return errors.New("JsonNumber does not support Put() operation")
}

func (jn *JsonNumber) Add(value interface{}) error {
	return errors.New("JsonNumber does not support Add() operation")
}

func (jn *JsonNumber) Size() int {
	return -1
}

func (jn *JsonNumber) GetAllPropName() ([]string, error) {
	return nil, errors.New("JsonNumber does not support GetAllPropName() operation")
}

func (jn *JsonNumber) Get(index int) (JsonElement, error) {
	return nil, errors.New("JsonNumber does not support Get() operation")
}

func (jn *JsonNumber) GetByName(name string) (JsonElement, error) {
	return nil, errors.New("JsonNumber does not support GetByName() operation")
}
